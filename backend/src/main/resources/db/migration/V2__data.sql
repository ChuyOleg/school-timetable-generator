...
VALUES
    ('Спортивний зал №1', 3, 1), ('Спортивний зал №2', 2, 1),
    ('Хімічний кабінет', 1, 1), ('Фізичний кабінет', 1, 1),
    ('Комп`ютерний клас №1', 1, 1), ('Комп`ютерний клас №2', 1, 1),
    ('Трудовий клас (дівчата)', 2, 1), ('Трудовий клас (хлопці)', 2, 1);
...
('Демешко Д.В.', 15, 1), ('Негода І.М.', 18, 1), ('Політило Е.З.', 18, 1),
('Сорока В.Р.', 18, 1), ('Губ`як О.В.', 21, 1), ('Падун О.Т.', 19, 1),
('Зубач Т.З.', 19, 1), ('Іваненко М.Ф.', 21, 1), ('Карасик Г.Я.', 20, 1),
('Босенко В.Л.', 22, 1), ('Кобець У.Б.', 20, 1), ('Денисюк І.Т.', 19, 1),
('Шимко В.А.', 21, 1), ('Толубко Ф.А.', 21, 1), ('Вайда Г.В.', 20, 1),
('Корнелюк І.М.', 21, 1), ('Бондар А.К.', 20, 1), ('Лавренюк О.П.', 16, 1),
('Гайовий Ш.А.', 16, 1), ('Бурлюк Р.О.', 21, 1), ('Сохацька Я.А.', 20, 1),
('Васько Т.В.', 19, 1), ('Бутенко Н.Л.', 16, 1), ('Коструба І.П.', 19, 1),
('Стешенко О.І.', 19, 1), ('Цибенко Ч.Д.', 19, 1), ('Бурміцька Ш.В.', 19, 1),
('Зуріцька Р.Я.', 18, 1), ('Бевз О.М.', 18, 1), ('Скорик Ф.П.', 18, 1),
('Батенко Е.П.', 18, 1), ('Кочерга В.М.', 20, 1), ('Доманицька В.Р.', 18, 1),
('Швець К.М.', 18, 1), ('Романюк З.В.', 15, 1), ('Плужник В.П.', 16, 1),
('Гальчак К.Р.', 15, 1), ('Мацкевич А.З.', 20, 1), ('Якименко К.П.', 15, 1),
('Безуглий Ц.А.', 20, 1), ('Дашенко Д.М.', 20, 1), ('Філь А.П.', 18, 1),
('Костець К.І.', 18, 1), ('Карпека Г.С.', 14, 1), ('Колесса С.І.', 14, 1),
('Дунець О.П.', 18, 1), ('Огієнко Є.В.', 18, 1);
