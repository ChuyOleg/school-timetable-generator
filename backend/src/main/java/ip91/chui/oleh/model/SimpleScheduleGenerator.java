    ...
    IntStream.range(0, lessonsCount)
        .forEach(i -> {
          ...
          if (isHalfSubjectPickTime(lessonsCount, halfSubjects.size()) || availableSubjects.isEmpty()) {
            ...
            group.getLessons().add(new Lesson(subject_1, timeSlot_1));
            group.getLessons().add(new Lesson(subject_2, timeSlot_2));
          } else {
            ...
            group.getLessons().add(new Lesson(subject, timeSlot));
          }
        });
  }
